...
namespace LocalTheatre.Controllers
{
    public class AnnouncementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AnnouncementId,Title,Announcement,Date,Category,Author")] Announcements announcements)
        {
            ...
            {
                Announcements announcemnet = new Announcements
                {
